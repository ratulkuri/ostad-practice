  ...
  return (
    <>
        <div className={`${isOpen ? "open" : ""} ${className?.length > 0 ? className : ""} acordion-item rounded-lg shadow-lg mb-4 overflow-hidden`}>
            <div className="accordion-header min-h-[60px] cursor-pointer relative flex items-center gap-4 py-1.5 sm:py-4 pl-16 sm:pl-20 pr-10 sm:pr-16 bg-gradient-to-r from-cyan-500 to-blue-500" onClick={toggle}>
